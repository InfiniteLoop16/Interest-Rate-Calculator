...
namespace InterestRateCalculator
{
    public class InterestCalculator
    {
        ...
        public double calculateIntr(double accBal){
            ...
            //If the account balance is less than 1000 but more than 0 then 1% interest is charged
            ...
            else if(accBal >= 1000 && accBal < 5000)
                intrAmnt = accBal * 0.015;
            //If the account balance is greater or equal to 5000 but less than 10000 then 2% interest is charged
            else if (accBal >= 5000 && accBal < 10000)
                intrAmnt = accBal * 0.02;
            //If the account balance is greater or equal to 10000 but less than 50000 then 2.5% interest is charged
            else if (accBal >= 10000 && accBal < 50000)
